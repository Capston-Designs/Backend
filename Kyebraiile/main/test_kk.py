...
def play(img):
    ...
    path = os.getcwd() + r"\main\chromedriver.exe"
    driver = webdriver.Chrome(r"C:\Users\j3hea\OneDrive\바탕 화면\Python-CapstonDesign-main\Kyebraiile\main\chromedriver.exe")
...
zz = play(r"C:\Users\j3hea\OneDrive\바탕 화면\Python-CapstonDesign-main\Kyebraiile\media\1.png")
print(zz)